    ...
    policy = jsonencode(
    {
      ...
      "Statement" : [
        ...
        },
        {
          ...
          "Resource" : "arn:aws:dynamodb:*:*:table/clould-portfolio-test"
        },
      ]
  })
}
...
data "archive_file" "zip_the_python_code" {
  ...
  output_path = "${path.module}/lambda/lambdaFunc.zip"
}
